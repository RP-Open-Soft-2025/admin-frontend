...
export function getVibeMeterData(profileData: ProfileApiResponse) {
  console.log('Transforming VibeMeter data:', profileData.company_data.vibemeter);
...
export function getPerformanceData(profileData: ProfileApiResponse) {
  console.log('Transforming Performance data:', profileData.company_data.performance);
...
export function getOnboardingData(profileData: ProfileApiResponse) {
  console.log('Transforming Onboarding data:', profileData.company_data.onboarding);
