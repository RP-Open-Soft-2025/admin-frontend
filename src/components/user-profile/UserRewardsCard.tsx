...
const dummyRewardsData: Reward[] = [
  {
    awardType: AwardType.STAR_PERFORMER,
    awardDate: '2023-03-15',
    rewardPoints: 500
  },
  {
    awardType: AwardType.BEST_TEAM_PLAYER,
    awardDate: '2023-06-30',
    rewardPoints: 300
  },
  {
    awardType: AwardType.INNOVATION,
    awardDate: '2023-09-22',
    rewardPoints: 450
  },
  {
    awardType: AwardType.LEADERSHIP,
        ...
        <div>
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between lg:mb-6">
            ...
            <div className="mt-2 sm:mt-0">
              <span className="text-xs text-gray-500 dark:text-gray-400">Total Reward Points:</span>
              <span className="ml-2 text-sm font-medium text-green-600 dark:text-green-400">{totalRewardPoints}</span>
            </div>
          </div>
          ...
          <div className="mt-6">
            ...
            <div className="mt-2 flex justify-between">
              <span className="text-xs text-gray-500 dark:text-gray-400">Current: {totalRewardPoints}</span>
              <span className="text-xs text-gray-500 dark:text-gray-400">Goal: 2000</span>
            </div>
          </div>
        </div>
      </div>
