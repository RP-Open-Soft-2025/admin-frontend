...
const AppSidebar: React.FC = () => {
	...
	return (
		<aside
			className={`fixed mt-16 flex flex-col lg:mt-0 top-0 px-5 left-0 bg-white dark:bg-gray-900 dark:border-gray-800 text-gray-900 h-screen transition-all duration-150 ease-in-out z-50 border-r border-gray-200 overflow-hidden
        ${
		...
		>
			...
			<div className="flex flex-col overflow-y-auto h-full transition-all duration-300">
				<nav className="mb-6 transition-all duration-300">
