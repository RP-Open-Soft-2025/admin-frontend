...
export default function Calendar({
  ...
  if (!mounted) {
    return <div className={cn("p-3 w-full h-[350px] bg-gray-50 dark:bg-gray-900 rounded-md", className)} />
  }
            ...
            return (
              <button
                ...
                className={cn(
                  ...
                  isToday(date) && !isSelected(date) && "bg-gray-100 text-gray-900 dark:bg-gray-800 dark:text-gray-200 font-semibold",
                  !isCurrentMonth && isOutside && "text-gray-400 dark:text-gray-500 opacity-50",
                  !isSelected(date) && !isToday(date) && isCurrentMonth && "hover:bg-gray-100 dark:hover:bg-gray-800",
