...
const PopoverTrigger = ({ asChild = false, ...props }: React.ComponentPropsWithoutRef<typeof PopoverPrimitive.Trigger> & { asChild?: boolean }) => {
  ...
  return <PopoverPrimitive.Trigger data-slot="popover-trigger" {...props} asChild={asChild} />
}
